      ...
      <div className='lg:w-[70%] h-3/4 md:h-full flex flex-col justify-center'>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center">
            ...
            />
            <label htmlFor="accept-terms" className="text-slate-600 ml-3 block text-sm">
              I accept the <a href="/terms" className="text-violet-700 font-medium hover:underline ml-1">Terms and Conditions</a>
            </label>
          </div>
        </div>
